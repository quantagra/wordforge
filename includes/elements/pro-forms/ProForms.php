...
class Brf_Pro_Forms extends \Bricks\Element
{
    ...
    private $required_independent_fields = ['hidden', 'step', 'calculation', 'heading', 'divider', 'turnstile'];
    ...
    public function set_controls()
    {
        ...
        $this->controls['notificationSuccessHeading'] = [
            ...
            'type'    => 'separator',
            'default' => esc_html__('Success!', 'bricks'),
        ];
                    ...
                    <?php if (!empty($field['options']) && ($field['type'] === 'checkbox' || $field['type'] === 'radio')) { ?>
                        <ul class="options-wrapper">
                            ...
                            <?php foreach ($options as $key => $value) { ?>
                                ...
                                ?>
                                <li>
                                    <input data-label="<?php echo esc_html($option_value); ?>" <?php echo $init_value === $option_key ? "checked" : "" ?> type="<?php echo esc_attr($field['type']); ?>" id="<?php echo esc_attr("form-field-{$field['id']}") . '-' . $key; ?>" name="<?php echo esc_attr("form-field-{$field['id']}"); ?>[]" <?php if (isset($field['required'])) {
